...
//put your code here
			...
			'size' => $filefield['size']);
                        ...
                        if(!empty($require_imagesize) && !empty($file['tmp_name']))
                        {
                            $imagesize = getimagesize($file['tmp_name']);
                             ...
                             {
                                 $too_small = sprintf( __( 'Image size exceeds the maximum limit. Maximum allowed image size is %d byte.','profilegrid-user-profiles-groups-and-communities' ), $require_imagesize['2'] );
                             }
                             elseif ( $image_width < $require_imagesize['0'] || $image_height < $require_imagesize['1'] ) 
                             {
                                 $too_small = sprintf( __( 'Image dimensions are too small. Minimum size is %d by %d pixels.','profilegrid-user-profiles-groups-and-communities' ), $require_imagesize['0'],$require_imagesize['1'] );
                             }
                             else
                             {
                                 $too_small = false;
			...
			{			
			  ...
			  if ( $movefile )
			  {
				  ...
				  else
				  {
                                        ...
                                        {
                                            return __("This file type is not allowed.",'profilegrid-user-profiles-groups-and-communities');
                                        }
                                        else
                                        {
					    return $too_small;
                        ...
                        if(!empty($field_options) && isset($field_options['admin_only']) && $field_options['admin_only']=="1" && !is_super_admin() )
                        {
                           continue;
                            ...
                            if($field->field_type=='user_email')
                            {
                                    ...
                                    {
                                            $error[] =  $field->field_name. __(" is a required field",'profilegrid-user-profiles-groups-and-communities');	
                                    }
                                    else
                                    {
                                            ...
                                            {
                                                    $error[] =  __("Please enter a valid e-mail address",'profilegrid-user-profiles-groups-and-communities');	 
                                            }

                                            if($this->profile_magic_check_user_email_exist($useremail))
                                            {
                                                    $error[] =  __("This user is already registered. Please try with different email.",'profilegrid-user-profiles-groups-and-communities');
                                            }
                                    }
                            }
                            if($field->field_type=='user_name')
                            {
                                    ...
                                    else
                                    {
                                            ...
                                            {
                                                $error[] =  __('This username is invalid because it uses illegal characters. Please enter a valid username.','profilegrid-user-profiles-groups-and-communities');
                                            }

                                            if($this->profile_magic_check_username_exist($username))
                                            {
                                                    $error[] =  __("Sorry, username already exist.",'profilegrid-user-profiles-groups-and-communities');
                                            }
                            ...
                            if($field->field_type=='user_pass')
                            {
                                    if(!isset($post[$field_key]) || $post[$field_key]=='')
                                    {
                                            $error[] =  $field->field_name. __(" is a required field",'profilegrid-user-profiles-groups-and-communities').'<br />';	
                                    }
                                    else
                                    {
                                            if(strlen($post[$field_key])<7)
                                            {
                                                    $error[] .=  __("Password is too short. At least 7 characters please!",'profilegrid-user-profiles-groups-and-communities').'<br />';
                                            }	
                                    }
                            }
                            if($field->field_type=='confirm_pass')
                            {
                                    ...
                                    else
                                    {
                                            ...
                                            {
                                                    $error[] .=  __("Password and confirm password do not match.",'profilegrid-user-profiles-groups-and-communities').'<br />';
                                            }	
                                    }
                            }
                            if($field->is_required == 1 && $field->field_type!='file' && $field->field_type!='user_avatar' && $field->field_type!='user_name' && $field->field_type!='user_email' && $field->field_type!='user_pass' && $field->field_type!='confirm_pass')
                            {
                                    ...
                                    else
                                    {
                                            if(is_array($post[$field_key]))
                                            {
                                                    ...
                                                    if(!isset($value) || $value=='') $error[] =  $field->field_name. __(" is a required field",'profilegrid-user-profiles-groups-and-communities').'<br />';
                                            }
                                    }
                            }
                                    ...
                                    if(is_array($filefield))
                                    {
                                            ...
                                            for( $i =0; $i<count($filefield['name']); $i++ ) 
                                            {
                                                    $file = array(
                                                     ...
                                                     {
                                                             $error[] = __("This file type is not allowed.",'profilegrid-user-profiles-groups-and-communities');
                                                     }
                                                    ...
                                                    if(!empty($require_imagesize))
                                                    {
                                                        $imagesize = getimagesize($file['tmp_name']);
                                                         ...
                                                         if(isset($require_imagesize[2]) && $file['size'] > $require_imagesize[2])
                                                         {
                                                             $error[] = sprintf( __( 'Image size exceeds the maximum limit. Maximum allowed image size is %d byte.','profilegrid-user-profiles-groups-and-communities' ), $require_imagesize['2'] );
                                                         }
                                                         elseif ( $image_width < $require_imagesize['0'] || $image_height < $require_imagesize['1'] ) 
                                                         {
                                                             $error[] = sprintf( __( 'Image dimensions are too small. Minimum size is %d by %d pixels.','profilegrid-user-profiles-groups-and-communities' ), $require_imagesize['0'],$require_imagesize['1'] );
                                                         }
                            ...
                            if($field->field_type=='email' && isset($post[$field_key]) && $post[$field_key]!="")
                            {
                                     ...
                                     {
                                            $error[] =  __("Please enter a valid e-mail address",'profilegrid-user-profiles-groups-and-communities').'<br />';	 
                                     }
                            }
                            ...
                            if($field->field_type=='number' && isset($post[$field_key]) && $post[$field_key]!="")
                            {
                                     ...
                                     {
                                            $error[] =  __("Please enter a valid number",'profilegrid-user-profiles-groups-and-communities').'<br />';	 
                                     }
                            }
                            if($field->field_type=='pricing' && isset($post[$field_key]) && $post[$field_key]!="")
                            {
                                     if(is_numeric($post[$field_key])==false)
                                     {
                                            $error[] =  __("Please enter a valid amount",'profilegrid-user-profiles-groups-and-communities').'<br />';	 
                                     }
                            }		
                            if($field->field_type=='DatePicker' && isset($post[$field_key]) && $post[$field_key]!="")
                            {
                                     ...
                                     {
                                            $error[] =  __("Please enter a valid date (yyyy-mm-dd format)",'profilegrid-user-profiles-groups-and-communities').'<br />';	 
                                     }
                            }
                    }
                }
	...
	public function profile_magic_get_error_message($error_code,$textdomain)
	{
		...
		{
			case 'empty_username':
				$message = __( 'You do have an email address, right?','profilegrid-user-profiles-groups-and-communities' );
				break;	 
			case 'empty_password':
				$message = __( 'You need to enter a password to login.','profilegrid-user-profiles-groups-and-communities' );
				break;
			case 'invalid_username':
				$message = __("We don't have any users with that email address. Maybe you used a different one when signing up?",'profilegrid-user-profiles-groups-and-communities');
				break;
			case 'incorrect_password':
				$err = __("You entered incorrect password. Please try again or click on <a href='%s'>“Forgot Password”</a>",'profilegrid-user-profiles-groups-and-communities');
				...
				$message =  sprintf( $err, $forget_password_url );
                                break;
			case 'empty_username':
				$message = __( 'You need to enter your email address to continue.','profilegrid-user-profiles-groups-and-communities');
				break;
			case 'account_disabled':
				$message = __('Account disabled.','profilegrid-user-profiles-groups-and-communities');
				break;
			case 'payment_pending':
				$url = __("Your account has been deactivated due to a pending payment. <a href='%s'>Do you wish to pay now?</a>",'profilegrid-user-profiles-groups-and-communities');
				$message =  sprintf( $url,$this->pm_get_repayment_url($_REQUEST['id']));
				break;
			 
			case 'invalid_email':
				$message = __( 'We could not recognize the email address you just entered. Please check back and try again.','profilegrid-user-profiles-groups-and-communities' );
				break;
			case 'invalidcombo':
				$message = __( 'We could not recognize the username or email address you just entered. Please check back and try again.','profilegrid-user-profiles-groups-and-communities' );
				break;
			case 'expiredkey':
				$message = __( 'The password reset link you used is not valid anymore.','profilegrid-user-profiles-groups-and-communities' );
				break;
			case 'invalidkey':
				$message = __( 'The password reset link you used is not valid anymore.','profilegrid-user-profiles-groups-and-communities' );
				break;
			...
			case 'password_reset_mismatch':
				$message = __( "The two passwords you entered don't match.",'profilegrid-user-profiles-groups-and-communities' );
				break;
				 
			case 'password_reset_empty':
				$message = __( "Sorry, we don't accept empty passwords.",'profilegrid-user-profiles-groups-and-communities' );
				break;
			case 'password_too_short':
				$message = __( "Password is too short. At least 7 characters please!",'profilegrid-user-profiles-groups-and-communities' );
				break;
			...
			case 'loginrequired':
				...
				break;
			case 'not_permitted':
				$message = __("You do not have permission to view this page.",'profilegrid-user-profiles-groups-and-communities');
				break;
			case 'ajx_failed_del':
				$message = __("Failed to upadte user information.Can not activate user.",'profilegrid-user-profiles-groups-and-communities');
				break;
                        case 'invalid_code':
				$message = __("Invalid Activation code.",'profilegrid-user-profiles-groups-and-communities');
				break;
                        case 'pm_reset_pw_limit_exceed':
                                $message = __("You have reached the limit for requesting password change for this user.","profilegrid-user-profiles-groups-and-communities");
                                break;
                        case 'inactivity':
                            $message = __("You have been logged out due to inactivity.",'profilegrid-user-profiles-groups-and-communities');
                            break;
                        case 'blocked_ip':
                            $message = __("Your IP has been Banned. You don't access this page.",'profilegrid-user-profiles-groups-and-communities');
                            break;
                        case 'blocked_email':
                            $message = __("Sorry, you cannot register since this email has been blocked by a site administrator.",'profilegrid-user-profiles-groups-and-communities');
                            break;
                        case 'blocked_domain':
                            $message = __("You don't able to logged in due to your domain has been blocked by administrator.",'profilegrid-user-profiles-groups-and-communities');
                            break;
                        case 'blocked_words':
                            $message = __("Sorry, you cannot registered with this username since it uses a word blocked by a site administrator.",'profilegrid-user-profiles-groups-and-communities');
                            break;
                        case 'blocked_email_on_login':
                            $message = __("Sorry, you are not allowed to login. This email has been blocked by a site administrator.",'profilegrid-user-profiles-groups-and-communities');
                            break;
                        case 'account_deleted':
                             $message = __("Your account was successfully removed and all profile data deleted.",'profilegrid-user-profiles-groups-and-communities');
                            break;
                        case 'need_activation':
                             $message = __("An activation link is sent to your email. Please verify.",'profilegrid-user-profiles-groups-and-communities');
                            break;
			default:
				$message = __( 'An unknown error occurred. Please try again later.','profilegrid-user-profiles-groups-and-communities' );
				break;
    	}
     	return $message;
	}
	...
	public function profile_magic_get_user_attachment($value,$key='')
	{
		...
		{ 
			...
			$attachment_html .='<span class="pm-attachment-title pm-dbfl"><a href="'.wp_get_attachment_url( $fileid ).'">'.get_the_title( $fileid ).'</a></span>';
                        if($key != '')
                        {
                        $attachment_html .='<a class="removebutton"><span onClick="pm_remove_attachment(this,\''.$key.'\','.$fileid.')" class="remove">'.__('Remove','profilegrid-user-profiles-groups-and-communities').'</span></a>';
                        }
		...
		{                     
                ?>
                    <span class="pm_frontend_attachment<?php if($key != '') { echo ' pm_edit_attachment'; }?>">
                        ...
                        <a class="pm_removebutton"><span onClick="pm_remove_attachment(this, '<?php echo $key ?>', <?php echo $fileid; ?>)" class="remove"><?php _e('Remove','profilegrid-user-profiles-groups-and-communities');?></span></a>
                    </span>
                <?php
                }
		unset($values);
	...
	{
		$avatar = get_avatar($userid, 274,'',false,array('class'=>'pm-user','force_display'=>true));
...
<div class="pm_five_star_Banner">
    ...
    <p align="center"><?php _e("Do you like ProfileGrid? Help us  make it better…Please rate it ",'profilegrid-user-profiles-groups-and-communities'); ?>
        <span class="pm-star">
            ...
            <i class="fa fa-star" aria-hidden="true"></i>
            <i class="fa fa-star" aria-hidden="true"></i>
        </span><?php _e(" Stars on ",'profilegrid-user-profiles-groups-and-communities'); ?><a target="_blank" href="https://wordpress.org/support/plugin/profilegrid-user-profiles-groups-and-communities/reviews/?rate=5#new-post"><?php _e("WordPress.org","profilegrid-user-profiles-groups-and-communities");?></a></p>
    </div>
    </div>
...
//            }
	...
	return apply_filters( 'get_edit_post_link', $link, $post->ID, $context );
        ...
        public function pg_auto_create_default_email_template($gid)
        {
            ...
            $tmpl_data = array('tmpl_name'=>'Membership Terminated','email_subject'=>'Membership Terminated','email_body'=>$body);
            $tmpl_arg = array('%s','%s','%s');
...
<table class="pg-group-members pg-blog-setting">
    <tbody>
        <tr>
            ...
            <th>&nbsp;</th>
            <th><?php _e('Title','profilegrid-user-profiles-groups-and-communities');?></th>
            <th><?php _e('Status','profilegrid-user-profiles-groups-and-communities');?></th>
            <th><?php _e('Last Modified','profilegrid-user-profiles-groups-and-communities');?></th>
            <th><?php _e('Author','profilegrid-user-profiles-groups-and-communities');?></th>
            <th>&nbsp;</th>
            <th>&nbsp;</th>
        </tr>
        <!--********************************-->
                        ...
                        <td>     
                            <div class="pg-setting-dropdown" onclick="pg_toggle_dropdown_menu(this)">
                                ...
                                <ul class="pg-dropdown-menu">
                                    <li><a onclick="pg_edit_blog_popup('blog','change_status','<?php echo $post->ID;?>','<?php echo $gid;?>')"><?php _e('Change Status','profilegrid-user-profiles-groups-and-communities'); ?></a></li>
                                    <li><a onclick="pg_edit_blog_popup('blog','access_control','<?php echo $post->ID;?>','<?php echo $gid;?>')"><?php _e('Access Control','profilegrid-user-profiles-groups-and-communities'); ?></a></li>
                                    <li><a onclick="pg_edit_blog_popup('blog','edit','<?php echo $post->ID;?>','<?php echo $gid;?>')"><?php _e('Edit','profilegrid-user-profiles-groups-and-communities'); ?></a></li>
                                    <li><a onclick="pg_edit_blog_popup('blog','add_admin_note','<?php echo $post->ID;?>','<?php echo $gid;?>')"><?php _e('Add Note','profilegrid-user-profiles-groups-and-communities'); ?></a></li>
                                    <?php if($is_user_active):?>
                                    <li><a onclick="pg_edit_blog_popup('blog','message','<?php echo $post->ID;?>','<?php echo $gid;?>')"><?php _e('Message','profilegrid-user-profiles-groups-and-communities'); ?></a></li>
                                    <?php else:?>
                                    <li><a class="pg-setting-disabled"><?php _e('Message','profilegrid-user-profiles-groups-and-communities'); ?></a></li>
                                    <?php endif;?>
                                </ul>
                            </div>
                        </td>
...
<?php }elseif(!empty($search)) { ?> 
     <div class='pg-alert-warning pg-alert-info'><?php _e('No blog posts matches your search.','profilegrid-user-profiles-groups-and-communities'); ?></div>
         <?php }else
         {
             ?><div class='pg-alert-warning pg-alert-info'><?php _e('No blog posts have been written by members of this group.','profilegrid-user-profiles-groups-and-communities'); ?></div><?php
         }
         ?>
        <?php
    ...
    public function pm_get_author_name_and_link($uid)
    {
       ...
       {
           return '<span title="'.__('Author is suspended','profilegrid-user-profiles-groups-and-communities').'">'.$name.'</span>';
       }
    }
 ...
 <table class="pg-group-members">
    <tbody>
        <tr>
            ...
            <th>&nbsp;</th>
            <th class="pg-group-member-name"><?php _e('First Name','profilegrid-user-profiles-groups-and-communities');?></th>
            <th class="pg-group-member-name"><?php _e('Last Name','profilegrid-user-profiles-groups-and-communities');?></th>
            <th>&nbsp;</th>
            <th><?php _e('Joined on','profilegrid-user-profiles-groups-and-communities');?></th>
            <th>&nbsp;</th>
            <th>&nbsp;</th>
            <th>&nbsp;</th> 
        </tr>
                            ...
                            <div class="pg-setting-dropdown" onclick="pg_toggle_dropdown_menu(this)">
                                ...
                                <ul class="pg-dropdown-menu">
                                    ...
                                    <?php $is_user_active = $this->pm_is_user_active($user->ID); if($is_user_active):?>
                                     <li><a onclick="pg_edit_blog_popup('member','reset_password','<?php echo $user->ID;?>','<?php echo $gid;?>')"><?php _e('Reset Password','profilegrid-user-profiles-groups-and-communities'); ?></a></li>
                                    <li><a onclick="pg_edit_blog_popup('member','message','<?php echo $user->ID;?>','<?php echo $gid;?>')"><?php _e('Message','profilegrid-user-profiles-groups-and-communities'); ?></a></li>
                                    <li><a href="<?php echo $this->pm_get_user_edit_profile_url($user->ID,$gid)?>"><?php _e('Edit Profile','profilegrid-user-profiles-groups-and-communities'); ?></a></li>
                                    <?php else:?>
                                    <li> <a class="pg-setting-disabled"><?php _e('Reset Password','profilegrid-user-profiles-groups-and-communities'); ?></a></li>
                                    <li><a class="pg-setting-disabled"><?php _e('Message','profilegrid-user-profiles-groups-and-communities'); ?></a></li>
                                    <li><a class="pg-setting-disabled"><?php _e('Edit Profile','profilegrid-user-profiles-groups-and-communities'); ?></a></li>
...
<?php 
    ...
    ?> 
     <div class='pg-alert-warning pg-alert-info'><?php _e('No user matches your search.','profilegrid-user-profiles-groups-and-communities'); ?></div>
         <?php }else
         {
            ?> 
    ...
    public function pm_get_all_users_from_group_grid_view($gid,$pagenum=1,$limit=10,$sort_by='first_name_asc',$search_in='user_login',$search='',$profile_magic,$pg_version)
    {
        $dbhandler = new PM_DBhandler;
        ...
        ?>
<?php if(!empty($users)){?>
     <input type="hidden" name="pg-groupid" id="pg-groupid" value="<?php echo $gid;?>" />
...
elseif(!empty($is_search)) {
    ?> 
     <div class='pg-alert-warning pg-alert-info'><?php _e('No user matches your search.','profilegrid-user-profiles-groups-and-communities'); ?></div>
         ...
         {
            ?> 
     <div class='pg-alert-warning pg-alert-info'><?php _e('There are no members in this group.','profilegrid-user-profiles-groups-and-communities'); ?></div>
         <?php 
         }
        ...
        if(!empty($gid_array))
        {
            ...
            foreach($gid_array as $gid)
            {
               ...
               if(!empty($groupinfo)){
                ?>
                <li>
                    <a href='<?php echo esc_url($group_page_link); ?>' title="<?php echo $groupinfo->group_name; ?>" >
    ...
    public function pg_leave_group($uid,$gid)
    {
        ...
        if($is_leader)
        {
            ...
            $subject = __('An Manager left the group','profilegrid-user-profiles-groups-and-communities');
            $message = __("Hello,","profilegrid-user-profiles-groups-and-communities");
            $message .= "<br />\r\n\r\n";
            ...
            if($requested==null)
            {
                if($this->profile_magic_check_is_group_member($gid,$current_user->ID))
                {
                   ...
                   <a class="pm_button" onclick="pg_edit_blog_popup('group','remove_group','<?php echo $current_user->ID;?>','<?php echo $gid;?>')">
                       <button><?php _e('Leave Group','profilegrid-user-profiles-groups-and-communities');?></button>
                   </a>
                    </div>
                    <?php
                    endif;
                            ...
                            <div class="pm-group-signup">
                                <form method="post">
                                    ...
                                    <a class="pm_button" onclick="submit()">
                                        <button type="submit"><?php _e('Join Group','profilegrid-user-profiles-groups-and-communities');?></button>
                                    </a>
                                </form>
                            </div>
                         <?php 
            ...
            ?>
                <div class="pm-group-signup">
                    <a href="<?php echo $registration_url;?>" class="pm_button">
                        <button><?php _e('Join Group','profilegrid-user-profiles-groups-and-communities');?></button>
                    </a>
                </div>
                <?php
                }
...
<table class="pg-group-requests pg-group-members">
    <tbody>
        <tr>
            ...
            <th class="pg-group-member-name"><?php _e('Last Name','profilegrid-user-profiles-groups-and-communities');?></th>
            <th>&nbsp;</th>
            <th><?php _e('Request Sent On','profilegrid-user-profiles-groups-and-communities');?></th>
            <th>&nbsp;</th>
            <th>&nbsp;</th>
            <th>&nbsp;</th>
        </tr>
...
<?php } else { ?> 
     <div class='pg-alert-warning pg-alert-info'><?php _e('There are no pending membership requests.','profilegrid-user-profiles-groups-and-communities'); ?></div>
<?php } 
        ...
        if(!empty($value))
        {
            ...
            else
            {
                ...
                if($rm_field_type=='Terms' && $field_type=='text')
                {
                    if($value=='on')
                    {
                        $value = __('Accepted Terms & Condition','profilegrid-user-profiles-groups-and-communities');
                    }
                    else
                    {
                        $value = __('Rejected Terms & Conditions','profilegrid-user-profiles-groups-and-communities');
                    }
	...
	if($row->group_options!="")
        ...
        if($group_page=="0")
        {
            $html = '<a onclick="pg_create_group_page('.$gid.')" title="'.__('Click to create page for this group','profilegrid-user-profiles-groups-and-communities').'"><i class="fa fa-plus"></i></a>';
        }
        else
        {
            $link = get_edit_post_link($group_page);
            $html = '<a href="'.$link.'" target="_blank" title="'.__('Click to edit the page for this group','profilegrid-user-profiles-groups-and-communities').'"><i class="fa fa-file"></i></a>';
        }
        return $html;
    }
    ...
    public function pm_get_all_groups_data($view='grid',$pagenum=1,$limit=10,$sort_by='newest',$search='')
    {
        ...
        {
    ?> 
     <div class='pg-alert-warning pg-alert-info'><?php _e('No group matches found.','profilegrid-user-profiles-groups-and-communities'); ?></div>
         <?php }else
         {
            ?> 
     <div class='pg-alert-warning pg-alert-info'><?php _e('There are not created any groups yet. Once admin have created a new group, it will appear here.','profilegrid-user-profiles-groups-and-communities'); ?></div>
         <?php 
         }
     ...
     <div class="pm_clear"></div>
        ...
        echo '<div class="pm-groups-pagination">'.$pagination.'</div>';
    ...
    public function pm_get_group_html($group,$view='grid')
    {
        ...
        if($dbhandler->get_global_option_value($option,'1')=='1')
        {
                ...
                <div class="pm-group pm-difl pm-border pm-radius5 pm-bg-lt pm50">
                  ...
                  <div class="pm-group-info pm-dbfl">
                    <div class="pm-group-logo pm-dbfl pm-bg pm-border-bt">
                        ...
                        <?php echo $this->profile_magic_get_group_icon($group); ?>
                        </div>
                  ...
                  <div class="pm-group-button pm-dbfl pm-pad10">
                   <div class="pm-group-signup"><a href="<?php echo $registration_url;?>" class="pm_button"><button><?php _e('Join Group','profilegrid-user-profiles-groups-and-communities');?></button></a></div>
                    ...
                    <div class="pm_group_price">
                      <?php if($dbhandler->get_global_option_value('pm_currency_position','before')=='before'):
                            echo $this->pm_get_currency_symbol().' '.$this->profile_magic_check_paid_group($group->id);
                        else:
                            echo $this->profile_magic_check_paid_group($group->id).' '.$this->pm_get_currency_symbol();
                        endif;
                        ?>
                    </div>
                    <?php else: ?>
                    <div class="pm_free_group"><?php _e('Free','profilegrid-user-profiles-groups-and-communities');?></div>
                    <?php endif; ?>
                    </div>
                   <?php else: ?>
                  <div class="pm-group-button pm-dbfl pm-pad10">
                   <div class="pm-group-signup">
                       <a href="<?php echo $group_url;?>" class="pm_button">
                           <button><?php _e('Details','profilegrid-user-profiles-groups-and-communities');?></button>
                       </a>
                   </div>
                  </div>
                  <?php endif;?>
            ...
            else
            {
                ...
                $registration_url  = $this->profile_magic_get_frontend_url('pm_registration_page','');
                $registration_url = add_query_arg( 'gid',$group->id, $registration_url );
                $group_type = ($this->profile_magic_get_group_type($group->id)=='open'? __('Public','profilegrid-user-profiles-groups-and-communities'):__('Private','profilegrid-user-profiles-groups-and-communities'));
                $group_leaders = $this->pg_get_group_leaders($group->id);
                ?>
         <div class="pm-group-list-view pm-dbfl">
             <div class="pm-group-logo pm-difl"> <?php echo $this->profile_magic_get_group_icon($group,'pm-group-badge'); ?></div>
             <div class="pm-group-name-desc pm-difl">
                 <div class="pm-group-heading pm-dbfl pm-pad10 pm-clip"><a href="<?php echo esc_url( $group_url ); ?>"><?php echo $group->group_name;?></a></div>
                 <?php
                                    $groupdesc = '';
                                    if(strlen($group->group_desc) > 150)
                                    {
                    ...
                    <div class="pm-group-list-view-info"><?php echo $group_type;?> / <a> <span><?php echo count($group_leaders);?></span></a> <?php echo $this->pm_get_group_admin_label($group->id);?> / <a><span><?php echo $this->pm_count_group_members($group->id);?></span></a> <?php _e('Members','profilegrid-user-profiles-groups-and-communities');?></div>
             </div>
    ...
    public function pm_show_profile_image_profile_page($uid,$cuid,$user_info)
    {
        ...
        {
            $html ='<div '.$id.' class="pm-profile-image pm-difl pm-pad10">'. get_avatar($user_info->user_email,150,'',false,array('class'=>'pm-user','force_display'=>true));
             ...
             $html .='<div class="pm-bg-dk pg-profile-change-img">
                <div id="pm-change-image" class="pg-item-image-change">
                  ...
                  $html .=   __('Update Image','profilegrid-user-profiles-groups-and-communities');
                $html .='</div>
                </div>';
               endif;
            $html .= '</div>';
    ...
    public function pm_profile_tabs()
    {
        ...
        $tabs['pg-about'] = array('id'=>'pg-about','title'=>__('About','profilegrid-user-profiles-groups-and-communities'),'status'=>'1','class'=>'pg-about-tab');
        $tabs['pg-groups'] = array('id'=>'pg-groups','title'=>__('Groups','profilegrid-user-profiles-groups-and-communities'),'status'=>'1','class'=>'pg-group-tab');
        $tabs['pg-blog'] = array('id'=>'pg-blog','title'=>__('Blog','profilegrid-user-profiles-groups-and-communities'),'status'=>$blog_tab_status,'class'=>'pg-blog-tab');
        $tabs['pg-messages'] = array('id'=>'pg-messages','title'=>__('Messages','profilegrid-user-profiles-groups-and-communities'),'status'=>$message_tab_status,'class'=>'pg-message-tab');
        $tabs['pg-notifications'] = array('id'=>'pg-notifications','title'=>__('Notifications','profilegrid-user-profiles-groups-and-communities'),'status'=>'1','class'=>'pg-notification-tab');
       ...
       if(isset($tab) && $tab['status']=='1')
       {
           switch($id)
           {
               ...
               case 'pg-notifications':
                    ...
                    ?>            
                    <li id="notification_tab" onclick="read_notification();" class="pm-profile-tab pm-pad10 <?php echo $tab['class'];?>"><a class="pm-dbfl" href="#<?php echo $tab['id'];?>" onclick="read_notification();"><?php _e($tab['title'],'profilegrid-user-profiles-groups-and-communities');?><b id="unread_notification_count" class="<?php echo $unread_notification_class; ?>"><?php echo $unread_notification;?></b></a></li>
                    <?php
                    }
                    break;
               case 'pg-about':
               ...
               case 'pg-friends':
                   ...
                   ?>
                    <li class="pm-profile-tab pm-pad10 <?php echo $tab['class'];?>"><a class="pm-dbfl" href="#<?php echo $tab['id'];?>"><?php _e( $tab['title'],'profilegrid-user-profiles-groups-and-communities');?></a></li>
                <?php 
                   break;
           ...
           <div class="pm-edit-group"><a href="<?php echo esc_url( $edit_group ); ?>" class="pm_button"><?php _e('Edit','profilegrid-user-profiles-groups-and-communities');?></a></div>
            <?php endif;?>
             ...
             <div class="pm-group-image pm-difl pm-border">
                  <?php echo $this->profile_magic_get_group_icon($row); ?>
                   
                  <?php //$this->profile_magic_get_join_group_button($gid);?>
             ...
             <div class="pm-group-description pm-difl pm-bg pm-pad10 pm-border">
         		...
         		<?php 
                            if(!class_exists('Profilegrid_Group_Multi_Admins')):                         
                                ...
                                $profile_url = $this->profile_magic_get_frontend_url('pm_user_profile_page','');
                                $slug = $this->pm_get_profile_slug_by_id($leaders['primary']);
                                $profile_url = add_query_arg( 'uid',$slug,$profile_url );
                                
                                ?>
                                <div class="pm-card-row pm-dbfl">
                                    <div class="pm-card-label pm-difl"><?php echo $this->pm_get_group_admin_label($gid); ?></div>
                                    <div class="pm-card-value pm-difl pm-group-leader-small pm-difl">
                                         <a href="<?php echo $profile_url ;?>">
                                             ...
                                             <?php echo $this->pm_get_display_name($leaders['primary'],true);?>
                                         </a>

...
<div class="pmagic"> 
  ...
  <div class="operationsbar">
    <div class="pmtitle">
      <?php _e('Members','profilegrid-user-profiles-groups-and-communities');?>
    </div>
   
    <div class="nav">
      <ul>
        <li><a href="user-new.php"><?php _e("New User",'profilegrid-user-profiles-groups-and-communities');?></a></li>
        ...
        <li><a href="https://profilegrid.co/documentation/users-profiles/" target="_blank"><?php _e("Help",'profilegrid-user-profiles-groups-and-communities');?></a></li>
  ...
  <div class="pm-popup pm-move-to-group pm-popup-height-auto" >
      ...
      <div class="pm-popup-field-name" style="padding:15px;" >
               ...
               <div class="pg-uim-notice-wrap pg-assign-user-group-waring"><div class="pg-uim-notice"> <?php _e('You are adding this user(s) to new group. All data associated with profile fields of old group will be merged and the user will have to edit and fill profile fields associated with the new group.','profilegrid-user-profiles-groups-and-communities'); ?></div></div>
    ...
    <table>
      ...
      <?php
          ...
          <tr class="<?php echo $class;?>">
            ...
            <td><a href="admin.php?page=pm_profile_view&id=<?php echo $entry->ID;?>"><?php _e('View','profilegrid-user-profiles-groups-and-communities');?></a></td>
          </tr>
          <?php } 
                        }
                        else
